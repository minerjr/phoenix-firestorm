...
private:
    ...
    typedef std::unordered_map<handle_t, LLTextureCacheWorker*> handle_map_t;
    ...
    typedef std::unordered_map<LLUUID,S32> size_map_t;
    size_map_t mTexturesSizeMap;
    S64 mTexturesSizeTotal;
    LLAtomicBool mDoPurge;

    typedef std::unordered_map<S32, Entry> idx_entry_map_t;
